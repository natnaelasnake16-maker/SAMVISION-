      ...
      <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 md:space-x-4">
          <button
            ...
            className="hidden xl:flex items-center space-x-2 text-[9px] font-black uppercase tracking-widest px-4 py-2.5 rounded-xl border border-slate-200/60 text-slate-500 hover:bg-white transition-all hover:text-primary"
          >
